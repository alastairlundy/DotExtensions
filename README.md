...
|-----------------------------|---------------------------------------------------------------------------------------------|----------------------------------------------------|
| AlastairLundy.Extensions.System | [AlastairLundy.Extensions.System Nuget](https://nuget.org/packages/AlastairLundy.Extensions.System) | ``dotnet add package AlastairLundy.Extensions.System`` |
...
Before building a release build, ensure you apply the relevant changes to the ``AlastairLundy.Extensions.System.csproj`` file:
...
Please see the [CONTRIBUTING.md file](https://github.com/alastairlundy/Extensions.System/blob/main/CONTRIBUTING.md) for code and localization contributions.

If you want to file a bug report or suggest a potential feature to add, please check out the [GitHub issues page](https://github.com/alastairlundy/Extensions.System/issues/) to see if a similar or identical issue is already open.
If there is not already a relevant issue filed, please [file one here](https://github.com/alastairlundy/Extensions.System/issues/new) and follow the respective guidance from the appropriate issue template.
